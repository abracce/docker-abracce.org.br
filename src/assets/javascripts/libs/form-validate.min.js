...
/*! WordPress comments validation. */
jQuery(document).ready(function(a){a("#commentform").validate({rules:{author:{required:true,minlength:2},email:{required:true,email:true},url:{url:true},comment:{required:true,minlength:10}}});});
