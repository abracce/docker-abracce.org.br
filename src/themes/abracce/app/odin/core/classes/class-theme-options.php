...
class Odin_Theme_Options {
	...
	function scripts() {
		...
		if ( isset( $_GET['page'] ) && $this->id == $_GET['page'] ) {
			...
			// Theme Options.
			wp_enqueue_style( 'odin-admin', ODIN_URL . '/core/assets/css/admin.css', array(), null, 'all' );
			wp_enqueue_script( 'odin-admin', ODIN_URL . '/core/assets/js/admin.js', array( 'jquery' ), null, true );
	...
	public function callback_image( $args ) {
		...
		$image = ODIN_URL . '/core/assets/images/placeholder.png';
